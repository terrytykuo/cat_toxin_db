export const meta = {
  name: 'toxin-p2-round2-factual-fix',
  description: 'Apply the 16 authority-grounded factual corrections from the P2 refute round-2 audit to canonical disk files (EN *_processed + zh-TW), surgically via Edit',
...
// The 16 FAIL slugs from the P2 refute round-2 (data/audits/p2-refute-round2-fails-detail.json).
// slug -> category (where the EN canonical lives)
const ENTRIES = [
  { slug: 'mentha_spp', cat: 'plant' },
  { slug: 'milk_and_dairy_products', cat: 'food' },
  { slug: 'nandina_photina_spp', cat: 'plant' },
  { slug: 'peanuts', cat: 'food' },
  { slug: 'peony', cat: 'plant' },
  { slug: 'persimmons', cat: 'food' },
  { slug: 'pine', cat: 'plant' },
  { slug: 'pistachios', cat: 'food' },
  { slug: 'poppy', cat: 'plant' },
  { slug: 'potato_chips', cat: 'food' },
  { slug: 'pudding', cat: 'food' },
  { slug: 'ragwort__tansy', cat: 'plant' },
  { slug: 'raw_dough', cat: 'food' },
  { slug: 'strelitzia_reginae', cat: 'plant' },
  { slug: 'tradescantia_spathacea', cat: 'plant' },
  { slug: 'zephyranthes_drummondii', cat: 'plant' },
]
...
log(`P2 round-2 factual fixes applied to ${ok.length}/${ENTRIES.length} entries`)
return {
  fixed: ok.length,
