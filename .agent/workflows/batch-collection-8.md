...
1. Identify the next 8 unchecked plants in `data/collection_status.md` and note their IDs (e.g. 77, 78, 79, 80, 81, 82, 83, 84).
2. Edit `batch_collect.py` to set `target_indices` to these IDs minus 1 (e.g. `[76, 77, 78, 79, 80, 81, 82, 83, 84]`).
